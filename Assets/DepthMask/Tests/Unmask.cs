...
namespace UnityEngine.UI
{
    ...
    /// </remarks>
    public class Unmask : UIBehaviour, ICanvasRaycastFilter, IMaterialModifier
    {
        [NonSerialized]
        ...
        public virtual Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            {
                var maskMaterial = StencilMaterial.Add(baseMaterial, 1, (StencilOp)2, (CompareFunction)8, (ColorWriteMask)15);
                StencilMaterial.Remove(m_MaskMaterial);
                m_MaskMaterial = maskMaterial;

                var unmaskMaterial = StencilMaterial.Add(baseMaterial, 1, (StencilOp)2, (CompareFunction)8, (ColorWriteMask)15);
                StencilMaterial.Remove(m_UnmaskMaterial);
            ...
            graphic.canvasRenderer.hasPopInstruction = true;
            var unmaskMaterial2 = StencilMaterial.Add(baseMaterial,
