...
public class CollidersWindow : EditorWindow
{
    ...
    static void Init()
    {
        CollidersWindow sizeWindow = GetWindow<CollidersWindow>("Colliders Window");
        sizeWindow.autoRepaintOnSceneChange = true;
        sizeWindow.titleContent = new GUIContent("Colliders Window", EditorGUIUtility.IconContent("BoxCollider Icon").image);
        sizeWindow.Show();
    }
