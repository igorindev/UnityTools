...
namespace InputMap
{
    ...
    [CustomEditor(typeof(InputKeySpriteAtlas))]
    public class InputKeySpriteAtlasCustomEditor : Editor
    {
        InputKeySpriteAtlas _inputKeySpriteAtlas;

        private void OnEnable()
        {
            _inputKeySpriteAtlas = target as InputKeySpriteAtlas;
        }
        ...
        private void Create()
        {
            for (int i = 0; i < _inputKeySpriteAtlas._inputMaps.Length; i++)
            {
                InputKeySpriteAtlas.InputMap element = _inputKeySpriteAtlas._inputMaps[i];

                UpdateName(element.InputNames, element.SpriteAtlas);
