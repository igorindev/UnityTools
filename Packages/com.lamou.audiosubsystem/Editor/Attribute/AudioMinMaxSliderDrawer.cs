...
public class AudioMinMaxSliderDrawer : PropertyDrawer {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label){
        ...
        if(propertyType == SerializedPropertyType.Vector2){ 
            ...
            EditorGUI.MinMaxSlider(splittedRect[1], ref minVal, ref maxVal, (float)minMaxAttribute.min, (float)minMaxAttribute.max);
        ...
        else if(propertyType == SerializedPropertyType.Vector2Int)
        {
            ...
            (float)minMaxAttribute.min,(float)minMaxAttribute.max);
